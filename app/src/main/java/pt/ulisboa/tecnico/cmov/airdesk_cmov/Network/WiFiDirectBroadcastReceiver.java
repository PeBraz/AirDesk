    ...
    public void onReceive(Context context, Intent intent){
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                ...
                Toast.makeText(activity, "WiFi Direct enabled", Toast.LENGTH_SHORT).show();
                activity.discoverPeers();
            }
            else {
                activity.setWifiConnection(false);
                Toast.makeText(activity, "WiFi Direct disable", Toast.LENGTH_SHORT).show();
            }
            ...
            if (manager != null) {
                manager.requestPeers(channel, new WifiP2pManager.PeerListListener() {
                    ...
                    public void onPeersAvailable(WifiP2pDeviceList peers) {
                        System.out.println(String.format("PeerListListener: %d peers available",
